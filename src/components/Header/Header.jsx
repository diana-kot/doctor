        ...
        <div className="header__wrapper">
          <nav className="header__nav">
            <div className="header__right">
              <p className="header__title">Мой профиль</p>
            </div>
              ...
              <div className="header__left">
                ...
                <li className="header__item">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clipPath="url(#clip0_42_6411)">
                      <path
                        d="M9.03586 10.371C9.79308 10.371 10.4069 9.75719 10.4069 8.99997C10.4069 8.24275 9.79308 7.62891 9.03586 7.62891C8.27864 7.62891 7.66479 8.24275 7.66479 8.99997C7.66479 9.75719 8.27864 10.371 9.03586 10.371Z"
                        fill="white"
                      />
                      <path
                ...
                <li className="header__item">
                  <div className="header__avatar">
                    <img className="header__img" width="45" src={avatar} alt="avatar" />
                  </div>
                  <svg
                    width="16"
                    height="16"
                  ...
                  >
                    ...
                    <g clipPath="url(#clip0_42_6426)">
                      <path
                        d="M8.00187 10.1996L4.63147 6.8292L4.63147 6.8292C4.45269 6.65044 4.16285 6.65044 3.98407 6.8292L3.98403 6.82923C3.80533 7.00802 3.80531 7.29782 3.98404 7.4766L3.98406 7.47662L7.67816 11.1707L7.67818 11.1707C7.85695 11.3495 8.14678 11.3495 8.32556 11.1707L8.32557 11.1707L12.0197 7.47662L12.0197 7.47664L12.0215 7.47476C12.1972 7.29287 12.1921 7.00303 12.0102 6.82737L12.0102 6.82737C11.8328 6.65603 11.5515 6.65602 11.3741 6.82738L11.3741 6.82736L11.3723 6.8292L8.00187 10.1996Z"
                        fill="#50CAFF"
                        stroke="#50CAFF"
                        strokeWidth="0.3"
                      />
